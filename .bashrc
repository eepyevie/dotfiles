...
shopt -s autocd #Allows you to cd into directory meely by typing the directory name.
set -o vi
export EDITOR='vi'
export VISUAL='vi'
...
[ -f "$HOME/.config/shortcutrc" ] && source "$HOME/.config/shortcutrc" # load shortcut alieases
